    ...
    <div class="container">
      <div class="navbar-header">
        ...
        <div class="roomify-site-name">
          <div class="inner col-xs-6 col-xs-offset-2">
            <?php if ($logo): ?>
        ...
        <div class="roomify-user-menu">
          <!-- Ajax Cart Block -->
          <?php if ($block = module_invoke('dc_ajax_add_cart', 'block_view', 'ajax_shopping_cart_teaser')) : ?>
            <div class="ia-ajax-cart col-xs-2">
              <?php print $block['content']; ?>
            </div>
          <?php endif; ?>
          <div class="inner col-xs-1">
